...
Generated 2026-09-20 16:42 UTC by `python -m solarflare catalog`. Period 2024-02-01 00:00:00 → 2026-09-13 00:00:00; SoLEXS observed 758.8 days, HEL1OS 177.6 days. GOES-18 is used only to score, never to detect.

**9673 catalogue entries**: 994 seen by both instruments, 7331 by SoLEXS only, 1348 by HEL1OS only (665 of them while SoLEXS was not observing).

Are the HEL1OS-only flares real? 683 occurred while SoLEXS was observing; only 38 are in the GOES list, yet 59% show a simultaneous >3 sigma rise in SoLEXS 6-12 keV (39% above 5 sigma), against 14% (5%) at random quiet times: about half are real small hot flares that neither the GOES list nor the SoLEXS rule records.
...
|---|---|---|---|---|---|
| B | 66% (n=439) | 27% (4%) (n=135) | 0% | 74% (n=117) | 81% (75%) |
| C | 84% (n=5157) | 67% (17%) (n=1130) | 1% | 83% (n=810) | 90% (86%) |
| M | 90% (n=1084) | 84% (24%) (n=313) | 27% | 89% (n=253) | 94% (91%) |
| X | 99% (n=67) | 96% (38%) (n=24) | 92% | 100% (n=21) | 100% (100%) |
...
HEL1OS events inside a GOES flare: 53% of 2403; with non-thermal (CZT 20–40 keV) emission: 41% of 336.
...
|---|---|---|---|---|---|---|
| B | 1.0 | 51% | 1.0 | 55% | 59% | 1.0 |
| C | 2.0 | 74% | 3.0 | 82% | 56% | 1.0 |
| M | 5.0 | 87% | 6.0 | 92% | 47% | 0.0 |
| X | 9.0 | 100% | 10.0 | 100% | 70% | 1.5 |

## Test period only (from 2026-03-26)
...
| C | 86% (n=884) | 69% (14%) (n=390) | 0% | 87% (n=373) | 92% (89%) |
...
1048 matched flares: same letter 96%, median error 0.033 dex (bias +0.002), within a factor 1.5: 100%.
Without the peak-level correction: same letter 91%, median error 0.068 dex (bias +0.067).

| GOES class | n | same letter | median error (dex) | bias (dex) |
|---|---|---|---|---|
| B | 174 | 87% | 0.054 | +0.054 |
| C | 764 | 98% | 0.031 | -0.005 |
