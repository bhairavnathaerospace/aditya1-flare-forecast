"""Find SoLEXS day files that carry a copy of the previous day's data, and which copy is real.
    ...
    python scripts/solexs_duplicates.py
...
to outputs/catalog/solexs_duplicates.json, which scripts/master_catalog.py
...
def main() -> int:
    ...
    ap.add_argument("--out", default="outputs/catalog/solexs_duplicates.json")
    args = ap.parse_args()
