"""Figure for the master catalogue: detection by class, SoLEXS class vs GOES, one example day.
    ...
    python scripts/catalog_figures.py --day 2026-07-04

Reads <catalog>/catalog_summary.json and master_catalog.csv (from
scripts/master_catalog.py) and the cache for the light curves; writes
...
from solarflare.catalog import PiecewiseCalibration, to_minutes  # noqa: E402
