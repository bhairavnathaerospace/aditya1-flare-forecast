"""Phase 2: per-flare hot-onset and Neupert catalogue, and whether it helps forecast peaks.
    ...
    python scripts/physics_catalog.py --goes-dir D:/Data/goes --cache-dir outputs/archive/cache
...
from solarflare.physics.onset import flare_record, load_goes_xrs  # noqa: E402
...
def main() -> int:
    ...
    ap.add_argument("--out", default="outputs/physics")
